...
import AssignHorary from "./AssignHorary.vue";
import NotPermission from '@/Components/NotPermission.vue';

let pdvToEdit = ref(null);
let showModal = ref(false);
let showModalHorary = ref(false);
...
const horario = () => {
    showModalHorary.value = true;
};

const addPdv = () => {
    pdvToEdit.value = null;
    showModal.value = true;
};
                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                        ...
                        <div class="p-3">
                            <div class="overflow-x-auto rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <button
                                                    class="bg-blue-400 text-white p-1 rounded-md hover:bg-blue-600 cursor-pointer mr-1"
                                                    @click="goToAssignHorary(pdv)"
                                                >
                                ...
                                <Pagination :pagination="pdvs" />
                            </div>
                        </div>
                    </div>
                </div>
                <Modal :show="showModal" @close="showModal = false">
                    <PdvForm :pdv="pdvToEdit" @close-modal="closeModal" />
                </Modal>
                <Modal :show="showModalHorary" @close="showModalHorary = false">
                    <AssignHorary :data="horaries" :pdv="pdvToEdit" />
                </Modal>
            </div>
        </AppLayout>
    </div>
